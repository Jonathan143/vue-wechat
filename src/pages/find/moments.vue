      ...
      <div class="news">
        <div class="item" v-for="(item,index) in news" :key="index">
          ...
          <div class="info">
            ...
            <div class="time">
              <time>{{item.time}}</time>
              <svg class="icon" aria-hidden="true" style="color:#3f51b5;">
...
const news = [
  {name: 'Jonathan',text:
      '今天坐火车去了南阳看她,看她在大学里过得很开心,很舒适。我问她我在你心里到底是什么位置？一分钟后,她说了两个字:朋友。我陷入了沉默。看着她的侧脸,我想:四年了,我该开始自己的生活了。再见姑娘,再见南阳！ 《那些花儿》——朴树',img: 'https://yang143.cn/images/Selfie.jpg',time: '刚刚',py:'此不负经年，相聚有时，后会无期。不负流年，飘散如烟，后会无期。'},
  {name: '杰伦',text:
